...
//Not tested yet
router.post('/addCustomerInfo/:userId/:customerId', verifyToken, addCustomerInfo);
...
router.post('/addCustomerExerciesInfo/:userId/:customerId/:setExerciesToCustomerId', verifyToken, addCustomerExerciesInfo);
