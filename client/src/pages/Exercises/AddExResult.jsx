...
export default function AddExResult() {
  const [formData, setFormData] = useState({});
  const { setExerciesToCustomerId } = useParams();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://cautious-journey-5xx4666q445cvjp5-3000.app.github.dev/api/customerInfo/addCustomerExerciesInfo/${currentUser.userId}/${currentUser._id}/${setExerciesToCustomerId}`,
        {
          method: "POST",
          headers: {
