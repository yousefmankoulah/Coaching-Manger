...
export default function UpdateAssignEx() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://cautious-journey-5xx4666q445cvjp5-3000.app.github.dev/api/exercise/updateSetExercies/${currentUser._id}/${id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div>
              {formData && formData.customerId && formData.exerciseId && (
                <>
                  <div>
                    ...
                    >
                      {customers && customers.length > 0 ? (
                        <>
                          <option value={formData.customerId._id} selected>
                  ...
                  <div>
                    ...
                    >
                      {exercise && exercise.length > 0 ? (
                        <>
                          <option value={formData.exerciseId._id} selected>
