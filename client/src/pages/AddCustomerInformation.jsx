...
export default function AddCustomerInformation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://cautious-journey-5xx4666q445cvjp5-3000.app.github.dev/api/customerInfo/addCustomerInfo/${currentUser.userId}/${currentUser._id}`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <div className="min-h-screen mt-20">
      <h1 className="text-4xl text-center mt-10 mb-10">Add Your Information</h1>
